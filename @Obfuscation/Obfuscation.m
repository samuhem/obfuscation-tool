...
classdef Obfuscation
    ...
    properties (Constant)
        ...
        sql_legs_by_id =                                    ...
            strcat("SELECT *, ",                            ...
            "st_x(first_location) as firstloc_lon, ",       ...
            "st_y(first_location) as firstloc_lat, ",       ...
            "FROM legs WHERE obsolete = false and ",    ...
            "installation_id like ");
        
        sql_waypoints_by_id = ...
            strcat("SELECT *, st_x(location) as on, ",     ...
            "st_y(location) as lat, FROM waypoints ",       ...
            "WHERE installation_id like ");
        
        sql_places_by_id = ...
            strcat("SELECT *, st_x(location) as lon, ",     ...
            "st_y(location) as lat FROM places ",           ...
            "WHERE installation_id like ");
        
        sql_dwells_by_id = ...
            strcat("SELECT *, st_x(location) as lon, ",        ...
            "st_y(location) as lat, FROM dwells ",             ...
            "WHERE obsolete = false AND installation_id like ");
